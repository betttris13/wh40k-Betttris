...
<gameSystem id="28ec-711c-d87f-3aeb" name="Warhammer 40,000 9th Edition" revision="227" battleScribeVersion="2.03" authorName="BSData Developers" authorContact="@WH40k Data Dev" authorUrl="https://www.bsdata.net/contact" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  ...
  <categoryEntries>
    ...
    <categoryEntry id="3783-191d-0db9-0704" name="Non-Compulsory Fast Attack" hidden="false"/>
    <categoryEntry id="eca4-de83-1e4d-cdd6" name="War Dog-Class" hidden="false"/>
              ...
              <conditionGroups>
                <conditionGroup type="or">
                  <conditions>
                    ...
                    <condition field="selections" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="fff5-0cb2-3255-5678" type="atLeast"/>
                  </conditions>
                </conditionGroup>
              </conditionGroups>
            </modifier>
    ...
    <forceEntry id="cccd-3d99-d4af-d668" name="Brigade Detachment -4CP" hidden="false">
      ...
      <categoryLinks>
        ...
        <categoryLink id="d151-d45a-2c2a-b9ba" name="Fast Attack" hidden="false" targetId="c274d0b0-5866-44bc-9810-91c136ae7438" primary="false">
          <modifiers>
            <modifier type="increment" field="baef-14a4-74e0-79ce" value="1.0">
              <repeats>
    ...
    <forceEntry id="3c85-9649-d2da-9bde" name="Outrider Detachment -3CP" hidden="false">
      ...
      <categoryLinks>
        ...
        <categoryLink id="22b3-8488-1b3d-b0d4" name="Fast Attack" hidden="false" targetId="c274d0b0-5866-44bc-9810-91c136ae7438" primary="false">
          <modifiers>
            <modifier type="increment" field="2903-28dd-bd78-a2dc" value="1.0">
              <repeats>
                <repeat field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="3783-191d-0db9-0704" repeats="1" roundUp="false"/>
              </repeats>
            </modifier>
              ...
              <conditionGroups>
                <conditionGroup type="and">
                  ...
                  <conditionGroups>
                    <conditionGroup type="or">
                      <conditions>
                        <condition field="selections" scope="force" value="3.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="c08d-f66a-1d47-060f" type="atLeast"/>
                      </conditions>
                      <conditionGroups>
                        <conditionGroup type="and">
                          <conditions>
                            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="bdda-36f0-4f32-1639" type="atLeast"/>
                            <condition field="selections" scope="force" value="6.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="eca4-de83-1e4d-cdd6" type="atLeast"/>
                          </conditions>
                        </conditionGroup>
                        <conditionGroup type="and">
                          <conditions>
                ...
                <conditionGroup type="and">
                  ...
                  <conditionGroups>
                    <conditionGroup type="or">
                      <conditions>
                        <condition field="selections" scope="force" value="3.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="82b5-25ac-1710-de0e" type="atLeast"/>
                      </conditions>
                      <conditionGroups>
                        <conditionGroup type="and">
                          <conditions>
                            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="bdda-36f0-4f32-1639" type="atLeast"/>
                            <condition field="selections" scope="force" value="6.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="5583-2a3e-2095-6450" type="atLeast"/>
                          </conditions>
                        </conditionGroup>
                        <conditionGroup type="and">
                          <conditions>
        ...
        <modifier type="set" field="name" value="Super-Heavy Auxiliary Detachment 0CP">
          <conditionGroups>
            <conditionGroup type="and">
              <conditions>
                <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="ae09-117e-a6fa-316b" type="atLeast"/>
                <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="0f35-2c34-ba6a-8105" type="lessThan"/>
              </conditions>
              <conditionGroups>
                <conditionGroup type="or">
                  <conditions>
  ...
  <entryLinks>
    ...
    <entryLink id="ec87-f19e-eee2-1ba8" name="Detachment Command Cost" hidden="false" collective="false" import="true" targetId="9d97-2793-9882-d48a" type="selectionEntry">
      <categoryLinks>
...
- Unstable Position</characteristic>
    ...
    <selectionEntry id="bf09-85b2-c097-1071" name="Game Type" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
                      ...
                      <conditionGroups>
                        ...
                        <conditionGroup type="and">
                          ...
                          <conditionGroups>
                            <conditionGroup type="or">
                              <conditions>
                                <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="82b5-25ac-1710-de0e" type="lessThan"/>
                                <condition field="selections" scope="force" value="3.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="5583-2a3e-2095-6450" type="lessThan"/>
                              </conditions>
                            </conditionGroup>
                          </conditionGroups>
                        </conditionGroup>
                        ...
                        <conditionGroup type="and">
                          ...
                          <conditionGroups>
                            <conditionGroup type="or">
                              <conditions>
                                <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="82b5-25ac-1710-de0e" type="atLeast"/>
              ...
              <conditionGroups>
                ...
                <conditionGroup type="and">
                  ...
                  <conditionGroups>
                    <conditionGroup type="or">
                      <conditions>
                        <condition field="selections" scope="force" value="2.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="82b5-25ac-1710-de0e" type="greaterThan"/>
                      </conditions>
                      <conditionGroups>
                        <conditionGroup type="and">
                          <conditions>
                            <condition field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="bdda-36f0-4f32-1639" type="atLeast"/>
                            <condition field="selections" scope="force" value="5.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" childId="5583-2a3e-2095-6450" type="greaterThan"/>
                          </conditions>
                        </conditionGroup>
                        <conditionGroup type="and">
                          <conditions>
    ...
    <selectionEntry id="8129-3536-b511-b045" name="Shared Faction Bonus" hidden="false" collective="false" import="true" type="upgrade">
      ...
      <rules>
        ...
        <rule id="be6f-af81-c87c-b42b" name="Shared Faction Bonus" publicationId="977a-446b-737a-b571" page="4" hidden="false">
          <modifiers>
            <modifier type="set" field="hidden" value="true">
              <conditions>
    ...
    <selectionEntry id="ed98-6a58-e87d-0c0d" name="Army of Renown - Crusher Stampede" hidden="true" collective="false" import="true" type="upgrade">
      <costs>
        <cost name=" PL" typeId="e356-c769-5920-6e14" value="0.0"/>
        <cost name="CP" typeId="2d3b-b544-ad49-fb75" value="0.0"/>
        <cost name="pts" typeId="points" value="0.0"/>
    ...
    <selectionEntry id="fff5-0cb2-3255-5678" name="Army of Renown - Vanguard Spearhead" hidden="false" collective="false" import="true" type="upgrade">
      <categoryLinks>
        <categoryLink id="0311-6a19-b23f-e265" name="New CategoryLink" hidden="false" targetId="fcff-0f21-93e6-1ddc" primary="true"/>
      </categoryLinks>
      <costs>
        <cost name=" PL" typeId="e356-c769-5920-6e14" value="0.0"/>
        <cost name="CP" typeId="2d3b-b544-ad49-fb75" value="0.0"/>
    ...
    <selectionEntry id="cb1c-bf0d-9eb3-cb79" name="Army of Renown - Warpmeld Pact" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
        <constraint field="selections" scope="force" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="false" id="59f2-5b47-ab3f-9bb6" type="max"/>
      </constraints>
      <categoryLinks>
        <categoryLink id="35e0-7867-ee91-0c36" name="New CategoryLink" hidden="false" targetId="fcff-0f21-93e6-1ddc" primary="true"/>
      </categoryLinks>
      <costs>
        <cost name=" PL" typeId="e356-c769-5920-6e14" value="0.0"/>
        <cost name="CP" typeId="2d3b-b544-ad49-fb75" value="0.0"/>
